...
rmms = [
    0.05523296978114108,
    0.037755720134190485,
    0.022865694023377126,
    0.02045994014559044,
    0.027780520455162827,
    0.0203570360532751,
    0.002851480104821502,
    0.0197426645358596,
    0.008348358442480441,
    0.020906187147143207,
    0.021019699370123046,
    0.014695362060662354,
    0.016901042588589488,
    0.01472298172097497,
]
regs = [
    -0.33848762574863445,
    -0.04108421813228032,
    0.030339286105926337,
    0.12745685566177842,
    0.032846877782017045,
    0.14565735958500176,
    -0.04775419977387685,
    0.026328638043364935,
    0.19224026731762833,
    0.009367255236277123,
    0.08777331514254728,
    0.14436828519047082,
    0.1268419060455173,
    0.019537723548940532,
]
...
# plt.title(plan_name + "Plan" + election_names[j])
plt.axvline(x=0.026, color="orange", label="SM-Con")
...
evec = [
    [
        0.020978076408537227,
        0.023740272325305626,
        0.02918576512455516,
        0.030986984447037236,
        0.03334549754452667,
        0.03478019354134754,
        0.043058621500690016,
        0.04474671496947767,
        0.046149949126374615,
        0.04823043049715295,
        0.04912956883374996,
        0.05584345181818052,
        0.06609182668460183,
...
rvec = [
    [
        0.018361218970278193,
        0.02147162463571346,
        0.022240160881449065,
        0.024719667666142142,
        0.03213433066599333,
        0.032636710909495825,
        0.0367610496357045,
        0.047084281876020366,
        0.05179467999501321,
        0.05472018587054389,
        0.06031593860483849,
        0.06555162878857741,
...
for elect in range(14):
    ...
    if elect == 0:
        ...
        plt.plot([0.5, num_districts + 1], [0.4, 0.4], color="yellow", label="40%")
        plt.ylabel("BVAP %")
        plt.ylim([0, 0.7])
